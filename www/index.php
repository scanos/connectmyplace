...
as tdays,reg_date,status,cost,tag1 from todo where status=0 and pid ='$pid';";
$inner_counter=0;
...
echo "<td><a href=todo_image.php?tid=$id>I</a><font color='$tfont'>$risktext</td><td><a href=todo_edit.php?todo_id=$id>$id</a></td><td></b><input type='checkbox' name='lang[]' 
